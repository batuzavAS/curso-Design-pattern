...
class LiquidationBuilder {
    private basicSalaryMontly: number = 0;
    private monthsWorked: number  = 0;
    private pendingHolyDays: number = 0;
    private premiumEndYear: number = 0;
    private premiumMediumYear: number = 0;
    private layoffs: number = 0;
